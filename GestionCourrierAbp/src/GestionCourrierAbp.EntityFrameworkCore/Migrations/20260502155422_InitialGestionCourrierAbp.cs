...
{
    /// <inheritdoc />
    public partial class InitialGestionCourrierAbp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomService = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    Etage = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEquipements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEquipements_AppServices_ServiceId",
            ...
            migrationBuilder.CreateTable(
                name: "AppUtilisateurs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NomComplet = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUtilisateurs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUtilisateurs_AppServices_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "AppServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Statut = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ...
                    MessageReponse = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppTransactions_AppServices_DestinationServiceId",
                        column: x => x.DestinationServiceId,
                        principalTable: "AppServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppTransactions_AppServices_SourceServiceId",
                        column: x => x.SourceServiceId,
                        principalTable: "AppServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppTransactions_AppUtilisateurs_DestinationUserId",
                        column: x => x.DestinationUserId,
                        principalTable: "AppUtilisateurs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppEquipements_ServiceId",
                table: "AppEquipements",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTransactions_DestinationServiceId",
                table: "AppTransactions",
                column: "DestinationServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTransactions_DestinationUserId",
                table: "AppTransactions",
                column: "DestinationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTransactions_SourceServiceId",
                table: "AppTransactions",
                column: "SourceServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUtilisateurs_Login",
                table: "AppUtilisateurs",
                column: "Login",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppUtilisateurs_ServiceId",
                table: "AppUtilisateurs",
                column: "ServiceId");
