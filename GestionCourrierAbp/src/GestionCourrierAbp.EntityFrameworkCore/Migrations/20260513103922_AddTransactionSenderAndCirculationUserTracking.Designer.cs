...
namespace GestionCourrierAbp.Migrations
{
    ...
    [Migration("20260513103922_AddTransactionSenderAndCirculationUserTracking")]
    partial class AddTransactionSenderAndCirculationUserTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionCourrierAbp.Circulations.Circulation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppCirculations", (string)null);
                });

            modelBuilder.Entity("GestionCourrierAbp.Courriers.CourrierAdministratif", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppCourriersAdministratifs", (string)null);
                });
            ...
            modelBuilder.Entity("GestionCourrierAbp.Courriers.CourrierJudiciaire", b =>
                {
                    ...
                    b.Property<int?>("NumeroDossierAnnee")
                        .HasColumnType("int");

                    b.Property<int?>("NumeroDossierNombre")
                        .HasColumnType("int");

                    b.Property<int?>("NumeroDossierSujet")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionCourrierAbp.Courriers.RetraitJudiciaire", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CourrierJudiciaireId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CourrierJudiciaireId");

                    b.ToTable("AppRetraitsJudiciaires", (string)null);
                });

            modelBuilder.Entity("GestionCourrierAbp.Equipements.Equipement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppEquipements", (string)null);
                });

            modelBuilder.Entity("GestionCourrierAbp.Registres.Registre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppRegistres", (string)null);
                });

            modelBuilder.Entity("GestionCourrierAbp.Registres.Reponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppReponses", (string)null);
                });

            modelBuilder.Entity("GestionCourrierAbp.Services.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionCourrierAbp.Transactions.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ResponderServiceId")
                        .HasColumnType("int");

                    b.Property<string>("ResponderServiceName")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
            ...
            modelBuilder.Entity("GestionCourrierAbp.Utilisateurs.Utilisateur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppUtilisateurs", (string)null);
                });
            ...
            modelBuilder.Entity("GestionCourrierAbp.Courriers.RetraitJudiciaire", b =>
                {
                    b.HasOne("GestionCourrierAbp.Courriers.CourrierJudiciaire", "CourrierJudiciaire")
                        .WithMany("Retraits")
                        .HasForeignKey("CourrierJudiciaireId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CourrierJudiciaire");
                });
            ...
            modelBuilder.Entity("GestionCourrierAbp.Registres.Reponse", b =>
                {
                    b.HasOne("GestionCourrierAbp.Registres.Registre", "Registre")
                        .WithMany("Reponses")
            ...
            modelBuilder.Entity("GestionCourrierAbp.Transactions.Transaction", b =>
                {
                    b.HasOne("GestionCourrierAbp.Services.Service", "DestinationService")
                        .WithMany()
                        .HasForeignKey("DestinationServiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GestionCourrierAbp.Utilisateurs.Utilisateur", "DestinationUser")
                        .WithMany()
                        .HasForeignKey("DestinationUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("GestionCourrierAbp.Services.Service", "SourceService")
                        .WithMany()
