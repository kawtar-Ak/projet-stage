...
namespace GestionCourrierAbp.OpenIddict;
...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateScopesAsync()
    {
        ...
        {
            Name = "GestionCourrierAbp", 
            DisplayName = "GestionCourrierAbp API", 
            Resources = { "GestionCourrierAbp" }
        });
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["GestionCourrierAbp_App:ClientId"];
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["GestionCourrierAbp_Swagger:ClientId"];
