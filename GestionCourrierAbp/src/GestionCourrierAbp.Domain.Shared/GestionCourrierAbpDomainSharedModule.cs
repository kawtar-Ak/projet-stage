...
public class GestionCourrierAbpDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        GestionCourrierAbpGlobalFeatureConfigurator.Configure();
        GestionCourrierAbpModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<GestionCourrierAbpDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<GestionCourrierAbpResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/GestionCourrierAbp");

            options.DefaultResourceType = typeof(GestionCourrierAbpResource);
        ...
        {
            options.MapCodeNamespace("GestionCourrierAbp", typeof(GestionCourrierAbpResource));
        });
    }
}
