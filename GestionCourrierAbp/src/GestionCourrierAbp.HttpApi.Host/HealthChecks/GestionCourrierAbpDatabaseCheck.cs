...
public class GestionCourrierAbpDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public GestionCourrierAbpDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
