...
using (var scope = app.Services.CreateScope())
{
    ...
    var servicesList = new List<Service>
    {
        ...
        new Service { IdService = 12, NomService = "إجراءات و جلسات الثلاثاء", Description = "Procedures et audiences mardi", Etage = "1er" },
        new Service { IdService = 13, NomService = "الحفظ",             Description = "Archivage", Etage = "Sous-sol" },
        new Service { IdService = 14, NomService = "إجراءات و جلسات الخميس", Description = "Procedures et audiences Jeudi", Etage = "1er" },
